...
namespace XML
{
    class DOM : IStrategy
    {
        ...
        public static Student Info(XmlNode node) 
        {
            ...
            nw.Group = node.ParentNode.ParentNode.Attributes.GetNamedItem("GROUP").Value;
            nw.Room = node.ParentNode.ParentNode.Attributes.GetNamedItem("ROOM").Value;
            nw.Surname = node.ParentNode.ParentNode.Attributes.GetNamedItem("SURNAME").Value;
            nw.Name = node.ParentNode.ParentNode.Attributes.GetNamedItem("NAME").Value;
            nw.Phonenumber = node.ParentNode.ParentNode.Attributes.GetNamedItem("PHONENUMBER").Value;
            return nw;
        }
